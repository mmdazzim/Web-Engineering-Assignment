...
$sql = "INSERT INTO donation (amount) VALUES ('$amount')";
    	...
    	<div class="container col-md-4 justify-content-center">
    		<div class=" text-black">
    			...
    			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
    				<label>RM</label>
    				<input type="button" name="amount50" class="btn btn-primary" value="50">
    				<input type="button" name="amount100" class="btn btn-primary" value="100">
    				<input type="button" name="amount250" class="btn btn-primary" value="250">
    				<input type="button" name="amount500" class="btn btn-primary" value="500">
    				<br></br>
    				<label>Other Amount: RM </label>
